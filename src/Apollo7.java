...
public class Apollo7 extends Spacecraft {
    ...
    private double morale; // Represents crew morale during the mission

    // Constructor
    public Apollo7(String model, String fuelType, String launchDate, String color, boolean autoPilot, double successProbability, String locationOfLaunch, String weatherCondition, String string) {
        ...
        setCrewMembers(new String[] { "Walter M. Schirra", "Donn F. Eisele", "R. Walter Cunningham" });
    }
