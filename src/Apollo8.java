...
public class Apollo8 extends Spacecraft {
	...
	public Apollo8(String model, String fuelType, String launchDate, double successProbability, String color, boolean autoPilot, String locationOfLaunch, String weatherCondition, String string) {
        ...
        // Set mission-specific details for Apollo 7
        setMissionDuration(260); // e.g., 260 hours
        setCrewMembers(new String[] { "Frank Borman, Commander;", "William A. Anders, lunar module pilot;", "James A. Lovell Jr., command module pilot;" });
	}
